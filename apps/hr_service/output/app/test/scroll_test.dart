...
void main() {
  testWidgets('LeaveRequestListScreen: scrolls when content overflows', (tester) async {
    ...
    await tester.scrollUntilVisible(find.byKey(const ValueKey('leave-request-15')), 300.0, scrollable: find.descendant(of: find.byType(ListView), matching: find.byType(Scrollable)));
    expect(find.byKey(const ValueKey('leave-request-15')), findsOneWidget, reason: 'row 15 should be reachable after scrolling');
  });
