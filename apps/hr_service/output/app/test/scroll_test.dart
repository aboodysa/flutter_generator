...
class _SeededLeaveRequestListCubit extends LeaveRequestListCubit {
  ...
  Future<void> load() async {
    emit(state.copyWith(
      ...
      leaveRequests: [
        LeaveRequest(id: 'leave-request-1', name: 'Sample LeaveRequest 1', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 1, status: LeaveStatus.values.first, reason: 'Sample item 1'),
        LeaveRequest(id: 'leave-request-2', name: 'Sample LeaveRequest 2', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 2, status: LeaveStatus.values.first, reason: 'Sample item 2'),
        LeaveRequest(id: 'leave-request-3', name: 'Sample LeaveRequest 3', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 3, status: LeaveStatus.values.first, reason: 'Sample item 3'),
        LeaveRequest(id: 'leave-request-4', name: 'Sample LeaveRequest 4', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 4, status: LeaveStatus.values.first, reason: 'Sample item 4'),
        LeaveRequest(id: 'leave-request-5', name: 'Sample LeaveRequest 5', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 5, status: LeaveStatus.values.first, reason: 'Sample item 5'),
        LeaveRequest(id: 'leave-request-6', name: 'Sample LeaveRequest 6', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 6, status: LeaveStatus.values.first, reason: 'Sample item 6'),
        LeaveRequest(id: 'leave-request-7', name: 'Sample LeaveRequest 7', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 7, status: LeaveStatus.values.first, reason: 'Sample item 7'),
        LeaveRequest(id: 'leave-request-8', name: 'Sample LeaveRequest 8', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 8, status: LeaveStatus.values.first, reason: 'Sample item 8'),
        LeaveRequest(id: 'leave-request-9', name: 'Sample LeaveRequest 9', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 9, status: LeaveStatus.values.first, reason: 'Sample item 9'),
        LeaveRequest(id: 'leave-request-10', name: 'Sample LeaveRequest 10', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 10, status: LeaveStatus.values.first, reason: 'Sample item 10'),
        LeaveRequest(id: 'leave-request-11', name: 'Sample LeaveRequest 11', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 11, status: LeaveStatus.values.first, reason: 'Sample item 11'),
        LeaveRequest(id: 'leave-request-12', name: 'Sample LeaveRequest 12', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 12, status: LeaveStatus.values.first, reason: 'Sample item 12'),
        LeaveRequest(id: 'leave-request-13', name: 'Sample LeaveRequest 13', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 13, status: LeaveStatus.values.first, reason: 'Sample item 13'),
        LeaveRequest(id: 'leave-request-14', name: 'Sample LeaveRequest 14', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 14, status: LeaveStatus.values.first, reason: 'Sample item 14'),
        LeaveRequest(id: 'leave-request-15', name: 'Sample LeaveRequest 15', leaveType: LeaveType.values.first, startDate: DateTime(2025), endDate: DateTime(2025), days: 15, status: LeaveStatus.values.first, reason: 'Sample item 15'),
      ],
    ));
  }
}
