...
void main() {
  ...
  testWidgets('QuestionListScreen renders (golden)', (tester) async {
    setupDependencies();
    ...
    await tester.pumpWidget(BlocProvider<QuestionListCubit>(
      ...
      child: MaterialApp(theme: buildTheme(), home: QuestionListScreen()),
    ));
    await tester.pumpAndSettle();
    await expectLater(find.byType(QuestionListScreen), matchesGoldenFile('goldens/question_list_screen.png'));
  });
