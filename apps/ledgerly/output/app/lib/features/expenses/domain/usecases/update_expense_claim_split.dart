...
class UpdateExpenseClaimSplit {
  final ExpenseClaimSplitRepository repository;
  const UpdateExpenseClaimSplit(this.repository);

  Future<void> call(ExpenseClaimSplit params) => repository.updateExpenseClaimSplit(params);
