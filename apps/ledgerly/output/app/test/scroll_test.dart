...
class _SeededExpenseClaimListCubit extends ExpenseClaimListCubit {
  ...
  Future<void> load() async {
    emit(state.copyWith(
      ...
      expenseClaims: [
        ExpenseClaim(id: 'expense-claim-1', name: 'Sample ExpenseClaim 1', amount: Money(minorUnits: 15000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-2', name: 'Sample ExpenseClaim 2', amount: Money(minorUnits: 25000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-3', name: 'Sample ExpenseClaim 3', amount: Money(minorUnits: 35000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-4', name: 'Sample ExpenseClaim 4', amount: Money(minorUnits: 45000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-5', name: 'Sample ExpenseClaim 5', amount: Money(minorUnits: 55000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-6', name: 'Sample ExpenseClaim 6', amount: Money(minorUnits: 65000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-7', name: 'Sample ExpenseClaim 7', amount: Money(minorUnits: 75000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-8', name: 'Sample ExpenseClaim 8', amount: Money(minorUnits: 85000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-9', name: 'Sample ExpenseClaim 9', amount: Money(minorUnits: 95000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-10', name: 'Sample ExpenseClaim 10', amount: Money(minorUnits: 105000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-11', name: 'Sample ExpenseClaim 11', amount: Money(minorUnits: 115000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-12', name: 'Sample ExpenseClaim 12', amount: Money(minorUnits: 125000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-13', name: 'Sample ExpenseClaim 13', amount: Money(minorUnits: 135000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-14', name: 'Sample ExpenseClaim 14', amount: Money(minorUnits: 145000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
        ExpenseClaim(id: 'expense-claim-15', name: 'Sample ExpenseClaim 15', amount: Money(minorUnits: 155000, currency: 'SAR'), status: ClaimStatus.values.first, exported: false),
      ],
    ));
  }
}
