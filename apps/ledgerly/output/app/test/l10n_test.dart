...
void main() {
  ...
  testWidgets('UserListScreen flips Directionality per locale, no RTL overflow, AR+EN goldens', (tester) async {
    setupDependencies();
    ...
    expect(Directionality.of(tester.element(find.byType(UserListScreen))), TextDirection.ltr);
    await expectLater(find.byType(UserListScreen), matchesGoldenFile('goldens/l10n_en.png'));
    ...
    expect(Directionality.of(tester.element(find.byType(UserListScreen))), TextDirection.rtl);
    await expectLater(find.byType(UserListScreen), matchesGoldenFile('goldens/l10n_ar.png'));
  });
