...
import 'package:rasheed_replica_keemart/core/di.dart';import 'package:rasheed_replica_keemart/generated.dart';
...
void main() {
  ...
  testWidgets('HomeScreen renders (golden)', (tester) async {
    setupDependencies();
    ...
    await tester.pumpWidget(BlocProvider<HomeCubit>(
      ...
      child: MaterialApp(theme: buildTheme(), home: HomeScreen()),
    ));
