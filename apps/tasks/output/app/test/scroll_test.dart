...
class _SeededFollowUpListCubit extends FollowUpListCubit {
  ...
  Future<void> load() async {
    emit(state.copyWith(
      ...
      followUps: [
        FollowUp(id: 'follow-up-1', taskId: 'Sample item 1', note: 'Sample item 1', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-2', taskId: 'Sample item 2', note: 'Sample item 2', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-3', taskId: 'Sample item 3', note: 'Sample item 3', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-4', taskId: 'Sample item 4', note: 'Sample item 4', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-5', taskId: 'Sample item 5', note: 'Sample item 5', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-6', taskId: 'Sample item 6', note: 'Sample item 6', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-7', taskId: 'Sample item 7', note: 'Sample item 7', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-8', taskId: 'Sample item 8', note: 'Sample item 8', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-9', taskId: 'Sample item 9', note: 'Sample item 9', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-10', taskId: 'Sample item 10', note: 'Sample item 10', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-11', taskId: 'Sample item 11', note: 'Sample item 11', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-12', taskId: 'Sample item 12', note: 'Sample item 12', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-13', taskId: 'Sample item 13', note: 'Sample item 13', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-14', taskId: 'Sample item 14', note: 'Sample item 14', createdAt: DateTime(2025)),
        FollowUp(id: 'follow-up-15', taskId: 'Sample item 15', note: 'Sample item 15', createdAt: DateTime(2025)),
      ],
    ));
  }
}
