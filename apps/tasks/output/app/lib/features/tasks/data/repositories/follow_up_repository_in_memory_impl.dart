...
class FollowUpRepositoryInMemoryImpl implements FollowUpRepository {
  final List<FollowUp> _items = [FollowUp(id: 'x', taskId: 'x', subject: 'Sample FollowUp', createdAt: DateTime(2024)), FollowUp(id: 'follow-up-1', taskId: 'Sample item 1', subject: 'Sample FollowUp 1', createdAt: DateTime(2025)), FollowUp(id: 'follow-up-2', taskId: 'Sample item 2', subject: 'Sample FollowUp 2', createdAt: DateTime(2025))];
