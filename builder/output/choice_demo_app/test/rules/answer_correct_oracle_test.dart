...
// Do not hand-edit this file; regenerate from IR + AnswerCorrect.oracle.json.
import 'package:flutter_test/flutter_test.dart';
import 'package:rasheed_replica_choice_demo/generated.dart';

void main() {
  test('case 1: expected true', () {
    final e = Pick(id: 'p-1', label: 'First', answer: AnswerOption.b, mood: MoodOption.happy);
    expect(AnswerCorrect().evaluate(e), equals(true));
  });

  test('case 2: expected false', () {
    final e = Pick(id: 'p-2', label: 'Second', answer: AnswerOption.a, mood: MoodOption.happy);
    expect(AnswerCorrect().evaluate(e), equals(false));
  });
